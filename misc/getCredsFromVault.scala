...
def getEC2pkcs7: String = {
  val pkcs7 = getPostContent("http://{ip}/latest/dynamic/instance-identity/pkcs7")
  pkcs7.split('\n').mkString
  pkcs7
}

def getEC2Role: String = {
  val role = getPostContent("http://{ip}/latest/meta-data/iam/security-credentials/")
  role
}
...
// getPassword("https://{ip}:8200", "/v1/dbops/staticsecrets/awsenvironments/", "xxx", "xxx", "xxx", "prod")